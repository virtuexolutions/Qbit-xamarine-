...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Microsoft.AppCenter.Crashes.Crashes+AndroidCrashListener, Microsoft.AppCenter.Crashes", Crashes_AndroidCrashListener.class, __md_methods);
	}
	...
	public Crashes_AndroidCrashListener ()
	{
		...
		if (getClass () == Crashes_AndroidCrashListener.class) {
			mono.android.TypeManager.Activate ("Microsoft.AppCenter.Crashes.Crashes+AndroidCrashListener, Microsoft.AppCenter.Crashes", "", this, new java.lang.Object[] {  });
		}
	}
